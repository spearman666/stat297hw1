...
```
 ...
 $$\mathbb{E} [var\left\{ v_1\left( \hat{\theta},n \right)| \hat{\theta} \right\}] = var\left\{v_1 \left( \theta_0,n \right)  \right\} +\mathbb{E}[O_p\left\{ D_1 \left(\theta^*,n \right)   \left(\hat{\theta}-\theta_0 \right),...D_p  \left(\theta^*,n\right) \left(\theta - \theta_0 \right) \right\}] \\= var\left\{v_1 \left( \theta_0,n \right)  \right\} + O \left( n^{-2} \right)\\ A \equiv[a_{i,j}]_{_{i,j=1,...p^*}}
$$
...
<p>you're a rebel</p>
 ...
 <p>
<textarea name="myTextBox" cols="10" rows="2" style="border:0px; background-color:#38B1F1;">
this is hard
</textarea>
<br />
<input type="submit" />
